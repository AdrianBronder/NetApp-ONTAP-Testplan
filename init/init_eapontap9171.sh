...
################################################################################
#
# Title:        init_eapontap9171.sh
# Author:       NetApp Inc. (badrian)
# Initial Date: 2025-08-06
# Description:  Prepare linux host "rhel1" in LoD lab
#               --> "Early Access for Unified ONTAP 9.17.1"
#
...
python3 -m pip install --upgrade requests six netapp_lib selinux flask Flask-LDAP3-Login jmespath pyyaml netapp_ontap botocore==1.31.0 boto3==1.28.0
...
ansible-playbook -i $PROJECTPATH/inventories/labondemand_9171 $SCRIPTPATH/init_helper/init_ad.yml

echo ""
echo ""
echo "--> Initializing Linux hosts"
ansible-playbook -i $PROJECTPATH/inventories/labondemand_9171 $SCRIPTPATH/init_helper/init_linux.yml

echo ""
echo ""
echo "--> Prepare storage clusters in LoD (cluster1, cluster2, and cluster3)"
ansible-playbook -i $PROJECTPATH/inventories/labondemand_9171 $PROJECTPATH/playbooks/ONTAP-00/ONTAP-revert-00.yml
